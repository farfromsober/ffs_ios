...
- (void)testUserInitializedWithDictionaryWithNoUserIDShouldBeNil  {
    User *user = [[User alloc] initWithJSON:@{@"_id":@""}];
    XCTAssertNil(user, @"If JSON dictionary has no name, 'user' object should be nil");
}

- (void)testUserInitializedWithDictionaryWithNoUsernameShouldBeNil  {
    User *user = [[User alloc] initWithJSON:@{@"username":@""}];
...
- (void)testUserInitializedWithDictionaryWithNoEmailShouldBeNil  {
    User *user = [[User alloc] initWithJSON:@{@"email":@""}];
...
- (void)testUserInitializedWithIdUsernameAndEmailShouldBeCreated  {
    User *user = [[User alloc] initWithJSON:@{@"_id":@"12345", @"username":@"A name", @"email":@"email"}];
...
- (void)testUserCreatedShouldMatchInputFields  {
    ...
    XCTAssertTrue([user.userId isEqualToString:json[@"_id"]], @"'userId' should be equal tu json[\"_id\"]");
